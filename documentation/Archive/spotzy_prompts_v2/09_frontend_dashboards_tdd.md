...
Component tests first, then implementation for Host and Spotter dashboards.
...
**Booking cards:**
- Shows upcoming bookings with spotter name and dates
- "Message spotter" link renders correctly
...
## Component tests — Spotter Dashboard

### Tests first: `__tests__/pages/spotter-dashboard.test.tsx`
...
3. `app/dashboard/spotter/page.tsx`
