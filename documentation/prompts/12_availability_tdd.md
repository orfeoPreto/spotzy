...
describe('<AvailabilityGrid /> — display mode (guest, listing detail)', () => {
...
- When Guest selects a date range → validate client-side with `isWithinAvailabilityRules` before enabling "Book this spot"
