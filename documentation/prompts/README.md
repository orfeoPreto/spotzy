...
| 09 | `09_frontend_dashboards_tdd.md` | Component tests + Host dashboard + Guest dashboard | Frontend |
...
| 12 | `12_availability_tdd.md` | Availability resolver, rules CRUD, search + booking updates, AvailabilityGrid component | Backend + Frontend |
| 13 | `13_all_changes_tdd.md` | All delta features: profile, navigation, listing photo management, search updates, public profile, cancel fix, design system v2, E2E additions | Backend + Frontend |
